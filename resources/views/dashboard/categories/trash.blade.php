...
{{--                                  <img src="{{ asset('storage/' . $category->image) }}" width="50" height="50" alt="">--}}
                            ...
                            <td>
                                <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ $category->deleted_at }}</a>
                            </td>
                            <td class="text-end">
                                ...
                                <form action="{{ route('products.restore', $category->id) }}" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-4 me-2" method="post" >
                                    @csrf
                                    @method('put')
                                    <button type="submit" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-0 me-0" >restore</button>
                                </form>
                                <form action="{{ route('products.force-delete', $category->id) }}" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-4 me-2" method="post" >
                                    @csrf
                                    @method('delete')
                                    <button type="submit" class="btn btn-bg-light btn-color-muted btn-active-color-danger btn-sm px-0 me-0" >Delete</button>
                                </form>
