...
{{--                        <span class="text-muted mt-1 fw-bold fs-7">Over</span>--}}
                    ...
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="" data-bs-original-title="Click to show the trash">
                        <a href="{{ route('products.trash')}}" class="btn btn-sm btn-light btn-active-danger" >
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                            <span class="svg-icon svg-icon-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <rect opacity="0.5" x="11.364" y="20.364" width="16" height="2" rx="1" transform="rotate(-90 11.364 20.364)" fill="black"></rect>
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            ...
                            <tr class="fw-bolder text-muted">
                                ...
                                <th class="min-w-140px">Category products </th>
                                <th class="min-w-120px">price</th>
                                <th class="min-w-120px">description</th>
                                <th class="min-w-120px">status</th>
                                <th class="min-w-120px">created_at</th>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="{{route('products.show',$product->id)}}" class="text-dark fw-bolder text-hover-primary fs-6">{{$product->name}}</a>
                                                {{-- <span class="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span> --}}
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $product->id}}</a>
                                    </td>
                                    <td>
                                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $product->category->name ?? 'No category'}}</a>
                                    </td>
                                    <td>
                                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $product->price }}</a>
                                    </td>
                                    <td>
                                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $product->description }}</a>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ $product->status }}</a>
                                            {{-- <span class="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span> --}}
                                        </div>
                    </div>
                    </td>
                    <td>
                        {{-- <div class="d-flex justify-content-start flex-column">
                                <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ $product->created_at }}</a>
                                {{-- <span class="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span> --}}
                        {{-- </div>
                    </div> --}}
                    </td>
