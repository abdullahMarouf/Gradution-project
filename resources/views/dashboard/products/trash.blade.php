    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Trash</span>
...
{{--                                  <img src="{{ asset('storage/' . $product->image) }}" width="50" height="50" alt="">--}}
                            ...
                            <td>
                                <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ $product->description }}</a>
                            ...
                            <td>
                                <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ $product->deleted_at }}</a>
                            </td>
                            <td class="text-end">
{{--                                <button type="submit" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-4 me-2">restore</button>--}}
{{--                                <button type="submit" class="btn btn-bg-light btn-color-muted btn-active-color-danger btn-sm px-4">delete</button>--}}

                                <form action="{{ route('products.restore', $product->id) }}" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-4 me-2" method="post" >
                                    @csrf
                                    @method('put')
                                    <button type="submit" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-0 me-0" >restore</button>
                                </form>
                                <form action="{{ route('products.force-delete', $product->id) }}" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-4 me-2" method="post" >
                                    @csrf
                                    @method('delete')
                                    <button type="submit" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-0 me-0" >Delete</button>
                                </form>
