    ...
    <div class="col-xl-12 ">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form  action="{{route('products.update',$product->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    @method('PUT')
                    <x-alert/>
                    <!--begin::Input group-->
...
{{--                                     <input type="hidden" name="avatar_remove">--}}
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" name="name" id="name" value="{{old('name') ?? $product->name }}">
                        <!--end::Input-->
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        <!--begin::Label-->
                        <label class="fs-6 fw-semibold form-label mt-3">
                            <span class="required">Category id</span>
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Enter the contact's name." data-bs-original-title="Enter the contact's name." data-kt-initialized="1"></i>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" class="form-control form-control-solid" name="category_id" id="category_id" value="{{old('category_id') ?? $product->category_id }}">
                        <!--end::Input-->
                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                    <!--end::Input group-->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="number" name="price" id="price" class="form-control form-control-solid" value="{{old('price') ?? $product->price }}">
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                        </div>
                        ...
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <input type="number" name="compare_price" id="compare_price"  class="form-control form-control-solid" value="{{old('compare_price') ?? $product->compare_price }}">
                            </div>
                        </div>
                    </div>
                    <div class="col">
