    ...
    <div class="col-xl-12 ">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form  action="{{route('admins.update',$admin->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    @method('PUT')
                    <x-alert/>
                    <!--begin::Input group-->
...
{{--                                            </div>--}}
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" name="name" value="{{old('name') ?? $admin->name }}">
                            <!--end::Input-->
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <input type="email" class="form-control form-control-solid" name="email" value="{{old('email') ?? $admin->email }}">
                                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            ...
                            <div class="col">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="tel" class="form-control form-control-solid" name="mobile" value="{{old('phone') ?? $admin->phone }}">
                                </div>
                            </div>
                        </div>
                        <div class="fv-row mb-7">
