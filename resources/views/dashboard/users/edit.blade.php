    ...
    <div class="col-xl-12 ">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form  action="{{route('users.update',$user->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    @method('PUT')
                    <x-alert/>
                    <!--begin::Input group-->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="email" class="form-control form-control-solid" name="email" value="{{old('email') ?? $user->email }}">
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                        </div>
                        ...
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <input type="mobile" class="form-control form-control-solid" name="mobile" value="{{old('mobile') ?? $user->mobile }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <textarea class="form-control form-control-solid" name="address" value="{{old('address') ?? $user->address }}"></textarea>
                    </div>
